...
#
# Usage:
#   irm https://raw.githubusercontent.com/nelohenriq/hermes-agent-plus/master/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:nelohenriq/hermes-agent-plus.git"
$RepoUrlHttps = "https://github.com/nelohenriq/hermes-agent-plus.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/nelohenriq/hermes-agent-plus/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/nelohenriq/hermes-agent-plus/master/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
